...
def main():
    while (True):
        display_prompts()
        choice = input("Would you like to continue viewing stock data? Enter 'y' to continue: ").lower()
        if choice == "y":
            continue
        else:
